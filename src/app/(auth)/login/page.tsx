      ...
      <div className="p-4 rounded-lg bg-obsidian-900/80 border border-gold-500/30 text-xs space-y-2">
        ...
        <div className="grid grid-cols-2 gap-2 pt-1">
          <button
            ...
            className="p-2 rounded bg-obsidian-950 border border-obsidian-800 hover:border-gold-500/50 text-[11px] text-gray-300 hover:text-white transition-colors text-left"
          >
            <strong className="block text-gold-400 font-medium">Administrator</strong>
            <span className="text-gray-500 text-[10px]">admin@aurelia.com</span>
          </button>
