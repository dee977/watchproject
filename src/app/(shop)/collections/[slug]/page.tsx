    ...
    <div className="max-w-7xl mx-auto px-6 py-12 space-y-10">
      <div className="space-y-4 border-b border-obsidian-800 pb-8">
        <nav className="text-xs text-gray-500 flex items-center gap-2">
          ...
          <span>/</span>
          <Link href="/collections" className="hover:text-gold-400">Collections</Link>
          <span>/</span>
          <span className="text-gold-300">{collection.name}</span>
        </nav>
      ...
      <div className="space-y-6">
        <div className="flex items-center justify-between text-xs text-gray-400">
          <span>{products.length} Reference Editions Available</span>
        </div>
