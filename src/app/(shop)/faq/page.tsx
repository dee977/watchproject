    ...
    items: [
      {
        ...
        a: 'We accept Razorpay Secure Escrow (UPI, Visa, Mastercard, American Express, NetBanking, and No-Cost EMIs) as well as Cash on Delivery for eligible domestic addresses.',
      },
      {
